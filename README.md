...
### 3. Quark-Gluon Plasma Phase Transition
...
### 4. Hamiltonian Learning (Theory Generator)
...
2.  Install dependencies:
    ...
    ```
3.  Launch any notebook (e.g., `HamiltonianLearning.ipynb`) to replicate the experiments.
